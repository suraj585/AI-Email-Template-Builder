 ...
 * @public
 */
export type FieldTypeFromFieldPathInner<Document extends GenericDocument, FieldPath extends string> = FieldPath extends `${infer First}.${infer Second}` ? ValueFromUnion<Document, First, Record<never, never>> extends GenericDocument ? FieldTypeFromFieldPath<ValueFromUnion<Document, First, Record<never, never>>, Second> : ValueFromUnion<Document, First, Record<never, never>> extends GenericDocument | undefined ? FieldTypeFromFieldPath<ValueFromUnion<Document, First, Record<never, never>>, Second> | undefined : undefined : ValueFromUnion<Document, FieldPath, undefined>;
/**
