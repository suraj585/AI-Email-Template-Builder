...
export const dev = new Command("dev").summary("Develop against a dev deployment, watching for changes").description(
...
).allowExcessArguments(false).addDevOptions().addOption(
  new Option(
    "--configure [choice]",
  ...
  const partitionId = cmdOptions.partitionId ? parseInt(cmdOptions.partitionId) : void 0;
