...
async function selectEnvDeployment(ctx, options) {
  ...
  const deploymentNotice = deploymentType !== void 0 || deploymentName !== void 0 ? ` (on${deploymentType !== void 0 ? " " + chalk.bold(deploymentType) : ""} deployment${deploymentName !== void 0 ? " " + chalk.bold(deploymentName) : ""})` : "";
  return {
    deploymentUrl: url,
    adminKey,
    deploymentNotice
