...
export const CONVEX_SELF_HOST_URL_VAR_NAME = "CONVEX_SELF_HOST_URL";
export const CONVEX_SELF_HOST_ADMIN_KEY_VAR_NAME = "CONVEX_SELF_HOST_ADMIN_KEY";
const MAX_RETRIES = 6;
...
export async function getConfiguredDeploymentNameOrCrash(ctx) {
