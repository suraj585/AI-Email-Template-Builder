...
async function selectEnvDeployment(ctx, options) {
  ...
  const deploymentNotice = deploymentType !== void 0 || deploymentName !== void 0 ? ` (on${deploymentType !== void 0 ? " " + import_chalk.default.bold(deploymentType) : ""} deployment${deploymentName !== void 0 ? " " + import_chalk.default.bold(deploymentName) : ""})` : "";
  return {
    deploymentUrl: url,
    adminKey,
    deploymentNotice
