...
__export(utils_exports, {
  ...
  CONVEX_SELF_HOST_ADMIN_KEY_VAR_NAME: () => CONVEX_SELF_HOST_ADMIN_KEY_VAR_NAME,
  CONVEX_SELF_HOST_URL_VAR_NAME: () => CONVEX_SELF_HOST_URL_VAR_NAME,
  ...
  getConfiguredDeploymentNameOrCrash: () => getConfiguredDeploymentNameOrCrash,
...
var import_globalConfig = require("./globalConfig.js");
...
const CONVEX_SELF_HOST_URL_VAR_NAME = "CONVEX_SELF_HOST_URL";
const CONVEX_SELF_HOST_ADMIN_KEY_VAR_NAME = "CONVEX_SELF_HOST_ADMIN_KEY";
const MAX_RETRIES = 6;
...
async function getConfiguredDeploymentNameOrCrash(ctx) {
...
async function getConfiguredDeployment(ctx) {
  ...
  return (0, import_deployment.getConfiguredDeploymentFromEnvVar)();
}
