...
export declare const CONVEX_SELF_HOST_URL_VAR_NAME = "CONVEX_SELF_HOST_URL";
export declare const CONVEX_SELF_HOST_ADMIN_KEY_VAR_NAME = "CONVEX_SELF_HOST_ADMIN_KEY";
...
export declare function getConfiguredDeploymentNameOrCrash(ctx: Context): Promise<string>;
export declare function getConfiguredDeployment(ctx: Context): Promise<{
